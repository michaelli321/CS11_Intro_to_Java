...
public class Tricorn extends FractalGenerator {
	 ...
	 * for the mandelbrot algorithm. Our update function is simply
     * z_n = complex conjugate of z_{n-1}^2 + 1. We continue this iteration until either 
     * |z| > 2 or we have reached MAX_ITERATIONS in which the point
